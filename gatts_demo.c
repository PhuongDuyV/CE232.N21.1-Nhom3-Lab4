...
static const char *topic1 = "esp32/topic1";
...
#define SAMPLE_DEVICE_NAME          "Nhom 3 - Lop 1"
...
static const uint8_t char_mqtt_name[]  = "Read-Write to Broker";
...
static void mqtt_event_handler(void *handler_args, esp_event_base_t base, int32_t event_id, void *event_data)
{
    ...
    case MQTT_EVENT_DATA:
        ...
        esp_ble_gatts_set_attr_value(gatt_db_handle_table[IDX_CHAR_VAL_MQTT], event->data_len, (uint32_t *)event->data);
        break;
...
static void mqtt_app_start(void)
{
    esp_mqtt_client_config_t mqtt_cfg = {
        ...
        .credentials.username = "GcozSAIC7WoOcTcnu4dck6LkssXdkNCONOdvdLVav9OwROJbIMbRGMZZ4M2cptQ3"
    };
    ...
    switch (event) {
        ...
        case ESP_GATTS_READ_EVT:
            if(gatt_db_handle_table[IDX_CHAR_VAL_MQTT] == param->read.handle) {
                ...
                ESP_LOGI(EXAMPLE_TAG, "Read from broker");
            }
        case ESP_GATTS_WRITE_EVT:
            if (!param->write.is_prep)
            {
                ...
                {
                    int msg_id;
                    msg_id = esp_mqtt_client_publish(client, topic1, (char *)param->write.value, 0, 0, 0);
                    ESP_LOGI(TAG, "Write from BLE, msg_id=%d", msg_id);
                }
            }
            else
            {
